...
public class CrmMultiLangWebIT extends AbstractSharedMultiLangWebUiTest {

  @LocalServerPort
  private void setPort(int port) {
    CrmWebUiTestEx.LOCAL_PORT = port;
  }

  @Autowired
  private void setJdbcTemplate(JdbcTemplate jdbc) {
    CrmWebUiTestEx.JDBC = jdbc;
  }

  @Override
  public Class<CrmWebUiTestEx> getTestGuiClass() {
    return CrmWebUiTestEx.class;
  }
